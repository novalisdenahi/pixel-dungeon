...
public class Journal {
  ...
  public static enum Feature {
    WELL_OF_HEALTH("Well of Health"), WELL_OF_AWARENESS("Well of Awareness"), WELL_OF_TRANSMUTATION(
        "Well of Transmutation"), ALCHEMY("Alchemy pot"), GARDEN("Garden"), STATUE(
            "Animated statue"), PIRATE("Goblin pirate"), ASH("Ash"), GHOST("Sad ghost"), WANDMAKER(
                "Old wandmaker"), TROLL("Troll blacksmith"), IMP("Ambitious imp");
