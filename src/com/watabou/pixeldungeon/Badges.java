...
public class Badges {
  ...
  public static enum Badge {
    MONSTERS_SLAIN_1("10 enemies slain", 0), MONSTERS_SLAIN_2("50 enemies slain",
        1), MONSTERS_SLAIN_3("150 enemies slain", 2), MONSTERS_SLAIN_4("250 enemies slain",
            3), GOLD_COLLECTED_1("100 gold collected", 4), GOLD_COLLECTED_2("500 gold collected",
                5), GOLD_COLLECTED_3("2500 gold collected", 6), GOLD_COLLECTED_4(
                    "7500 gold collected",
                    7), LEVEL_REACHED_1("Level 6 reached", 8), LEVEL_REACHED_2("Level 12 reached",
                        9), LEVEL_REACHED_3("Level 18 reached",
                            10), LEVEL_REACHED_4("Level 24 reached", 11), ALL_POTIONS_IDENTIFIED(
                                    ...
                                    "All scrolls identified", 17), ALL_RINGS_IDENTIFIED(
                                        "All rings identified", 18), ALL_WANDS_IDENTIFIED(
                                            "All wands identified", 19), ALL_ITEMS_IDENTIFIED(
                                                ...
                                                35,
                                                true), BAG_BOUGHT_SEED_POUCH, BAG_BOUGHT_SCROLL_HOLDER, BAG_BOUGHT_WAND_HOLSTER, ALL_BAGS_BOUGHT(
                                                    "All bags bought",
                                                    23), DEATH_FROM_FIRE("Death from fire",
                                                        24), DEATH_FROM_POISON("Death from poison",
                                                            25), DEATH_FROM_GAS(
                                                                "Death from toxic gas",
                                                                26), DEATH_FROM_HUNGER(
                                                                    "Death from hunger",
                                                                    27), DEATH_FROM_GLYPH(
                                                                        "Death from an enchantment",
                                                                        57), DEATH_FROM_FALLING(
                                                                            "Death from falling down",
                                                                            59), YASD(
                                                                                "Death from fire, poison, toxic gas & hunger",
                                                                                34,
                                                                                true), BOSS_SLAIN_1_WARRIOR, BOSS_SLAIN_1_MAGE, BOSS_SLAIN_1_ROGUE, BOSS_SLAIN_1_HUNTRESS, BOSS_SLAIN_1(
                                                                                    "1st boss slain",
                                                                                    12), BOSS_SLAIN_2(
                                                                                        "2nd boss slain",
                                                                                        13), BOSS_SLAIN_3(
                                                                                            ...
                                                                                            14), BOSS_SLAIN_4(
                                                                                                "4th boss slain",
                                                                                                15), BOSS_SLAIN_1_ALL_CLASSES(
                                                                                                    "1st boss slain by Warrior, Mage, Rogue & Huntress",
                                                                                                    32,
                                                                                                    true), BOSS_SLAIN_3_GLADIATOR, BOSS_SLAIN_3_BERSERKER, BOSS_SLAIN_3_WARLOCK, BOSS_SLAIN_3_BATTLEMAGE, BOSS_SLAIN_3_FREERUNNER, BOSS_SLAIN_3_ASSASSIN, BOSS_SLAIN_3_SNIPER, BOSS_SLAIN_3_WARDEN, BOSS_SLAIN_3_ALL_SUBCLASSES(
                                                                                                        "3rd boss slain by Gladiator, Berserker, Warlock, Battlemage, Freerunner, Assassin, Sniper & Warden",
                                                                                                        33,
                                                                                                        true), RING_OF_HAGGLER(
                                                                                                            "Ring of Haggler obtained",
                                                                                                            20), RING_OF_THORNS(
                                                                                                                "Ring of Thorns obtained",
                                                                                                                21), STRENGTH_ATTAINED_1(
                                                                                                                    "13 points of Strength attained",
                                                                                                                    40), STRENGTH_ATTAINED_2(
                                                                                                                        "15 points of Strength attained",
                                                                                                                        41), STRENGTH_ATTAINED_3(
                                                                                                                            "17 points of Strength attained",
                                                                                                                            42), STRENGTH_ATTAINED_4(
                                                                                                                                    ...
                                                                                                                                    44), FOOD_EATEN_2(
                                                                                                                                        ...
                                                                                                                                        45), FOOD_EATEN_3(
                                                                                                                                            ...
                                                                                                                                            46), FOOD_EATEN_4(
                                                                                                                                                ...
                                                                                                                                                47), MASTERY_WARRIOR, MASTERY_MAGE, MASTERY_ROGUE, MASTERY_HUNTRESS, ITEM_LEVEL_1(
                                                                                                                                                    ...
                                                                                                                                                    48), ITEM_LEVEL_2(
                                                                                                                                                        ...
                                                                                                                                                        49), ITEM_LEVEL_3(
                                                                                                                                                            ...
                                                                                                                                                            50), ITEM_LEVEL_4(
                                                                                                                                                                ...
                                                                                                                                                                51), RARE_ALBINO, RARE_BANDIT, RARE_SHIELDED, RARE_SENIOR, RARE_ACIDIC, RARE(
                                                                                                                                                                    "All rare monsters slain",
                                                                                                                                                                    37,
                                                                                                                                                                    true), VICTORY_WARRIOR, VICTORY_MAGE, VICTORY_ROGUE, VICTORY_HUNTRESS, VICTORY(
                                                                                                                                                                        "Amulet of Yendor obtained",
                                                                                                                                                                        22), VICTORY_ALL_CLASSES(
    ...
    private Badge(final String description, final int image) {
      this(description, image, false);
    }

    private Badge(final String description, final int image, final boolean meta) {
  ...
  public static void disown(final Badge badge) {
    Badges.loadGlobal();
    global.remove(badge);
    saveNeeded = true;
  }

  private static void displayBadge(final Badge badge) {
  ...
  public static List<Badge> filtered(final boolean global) {
    ...
    Badges.leaveBest(filtered, Badge.MONSTERS_SLAIN_1, Badge.MONSTERS_SLAIN_2,
        Badge.MONSTERS_SLAIN_3,
        Badge.MONSTERS_SLAIN_4);
    Badges.leaveBest(filtered, Badge.GOLD_COLLECTED_1, Badge.GOLD_COLLECTED_2,
        Badge.GOLD_COLLECTED_3,
        Badge.GOLD_COLLECTED_4);
    Badges.leaveBest(filtered, Badge.BOSS_SLAIN_1, Badge.BOSS_SLAIN_2, Badge.BOSS_SLAIN_3,
        Badge.BOSS_SLAIN_4);
    Badges.leaveBest(filtered, Badge.LEVEL_REACHED_1, Badge.LEVEL_REACHED_2, Badge.LEVEL_REACHED_3,
        Badge.LEVEL_REACHED_4);
    Badges.leaveBest(filtered, Badge.STRENGTH_ATTAINED_1, Badge.STRENGTH_ATTAINED_2,
        Badge.STRENGTH_ATTAINED_3, Badge.STRENGTH_ATTAINED_4);
    Badges.leaveBest(filtered, Badge.FOOD_EATEN_1, Badge.FOOD_EATEN_2, Badge.FOOD_EATEN_3,
        Badge.FOOD_EATEN_4);
    Badges.leaveBest(filtered, Badge.ITEM_LEVEL_1, Badge.ITEM_LEVEL_2, Badge.ITEM_LEVEL_3,
        Badge.ITEM_LEVEL_4);
    Badges.leaveBest(filtered, Badge.POTIONS_COOKED_1, Badge.POTIONS_COOKED_2,
        Badge.POTIONS_COOKED_3,
        Badge.POTIONS_COOKED_4);
    Badges.leaveBest(filtered, Badge.BOSS_SLAIN_1_ALL_CLASSES, Badge.BOSS_SLAIN_3_ALL_SUBCLASSES);
    Badges.leaveBest(filtered, Badge.DEATH_FROM_FIRE, Badge.YASD);
    Badges.leaveBest(filtered, Badge.DEATH_FROM_GAS, Badge.YASD);
    Badges.leaveBest(filtered, Badge.DEATH_FROM_HUNGER, Badge.YASD);
    Badges.leaveBest(filtered, Badge.DEATH_FROM_POISON, Badge.YASD);
    Badges.leaveBest(filtered, Badge.ALL_POTIONS_IDENTIFIED, Badge.ALL_ITEMS_IDENTIFIED);
    Badges.leaveBest(filtered, Badge.ALL_SCROLLS_IDENTIFIED, Badge.ALL_ITEMS_IDENTIFIED);
    Badges.leaveBest(filtered, Badge.ALL_RINGS_IDENTIFIED, Badge.ALL_ITEMS_IDENTIFIED);
    Badges.leaveBest(filtered, Badge.ALL_WANDS_IDENTIFIED, Badge.ALL_ITEMS_IDENTIFIED);
    Badges.leaveBest(filtered, Badge.VICTORY, Badge.VICTORY_ALL_CLASSES);
    Badges.leaveBest(filtered, Badge.VICTORY, Badge.HAPPY_END);
    Badges.leaveBest(filtered, Badge.VICTORY, Badge.CHAMPION);
  ...
  public static boolean isUnlocked(final Badge badge) {
    return global.contains(badge);
  }

  private static void leaveBest(final HashSet<Badge> list, final Badge... badges) {
  ...
  public static void loadLocal(final Bundle bundle) {
  ...
  private static HashSet<Badge> restore(final Bundle bundle) {
  ...
  public static void saveLocal(final Bundle bundle) {
    Badges.store(bundle, local);
  }

  private static void store(final Bundle bundle, final HashSet<Badge> badges) {
    int count = 0;
  ...
  public static void validateAllBagsBought(final Item bag) {
  ...
  public static void validateAllPotionsIdentified() {
    if ((Dungeon.hero != null) && Dungeon.hero.isAlive() &&
      ...
      Badges.validateAllItemsIdentified();
    }
  }
  ...
  public static void validateChampion() {
    Badges.displayBadge(Badge.CHAMPION);
  }
  ...
  public static void validateMasteryCombo(final int n) {
  ...
  public static void validateRare(final Mob mob) {
