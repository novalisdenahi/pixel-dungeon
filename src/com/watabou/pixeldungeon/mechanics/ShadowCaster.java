...
public final class ShadowCaster {
    ...
    public static void castShadow(final int x, final int y, final boolean[] fieldOfView, final int distance) {
    ...
    private static void scanSector(final int cx, final int cy, final int m1, final int m2, final int m3, final int m4) {
