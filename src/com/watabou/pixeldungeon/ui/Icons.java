...
public enum Icons {
  ...
  SKULL, BUSY, COMPASS, PREFS, WARNING, TARGET, WATA, WARRIOR, MAGE, ROGUE, HUNTRESS, PRIEST, CLOSE, DEPTH, SLEEP, ALERT, SUPPORT, SUPPORTED, BACKPACK, SEED_POUCH, SCROLL_HOLDER, WAND_HOLSTER, KEYRING, CHECKED, UNCHECKED, EXIT, CHALLENGE_OFF, CHALLENGE_ON, RESUME;
