...
public class SurfaceScene extends PixelScene {
    ...
    private static class Avatar extends Image {
        ...
        public Avatar(final HeroClass cl) {
    ...
    private static class Cloud extends Image {
        ...
        public Cloud(final float y, final boolean dayTime) {
    ...
    private static class GrassPatch extends Image {
        ...
        public GrassPatch(final float tx, final float ty, final boolean forward) {
    ...
    private static class Sky extends Visual {
        ...
        public Sky(final boolean dayTime) {
            super(0, 0, 1, 1);
    ...
    public void create() {
        ...
        float vx = PixelScene.align((w - SKY_WIDTH) / 2);
        float vy = PixelScene.align((h - SKY_HEIGHT - BUTTON_HEIGHT) / 2);
