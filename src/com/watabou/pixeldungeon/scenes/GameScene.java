...
public class GameScene extends PixelScene {
  ...
  private static final String TXT_NIGHT_MODE =
  ...
  private static final String TXT_SECRETS =
  ...
  public static void add(final EmoIcon icon) {
    scene.emoicons.add(icon);
  }

  public static void add(final Heap heap) {
    if (scene != null) {
      scene.addHeapSprite(heap);
    }
  }

  public static void add(final Mob mob) {
  ...
  public static void add(final Mob mob, final float delay) {
    Dungeon.level.mobs.add(mob);
  ...
  public static void add(final Plant plant) {
    if (scene != null) {
  ...
  public static void discard(final Heap heap) {
    if (scene != null) {
      scene.addDiscardedSprite(heap);
    }
  }

  public static void discoverTile(final int pos, final int oldValue) {
    if (scene != null) {
      scene.tiles.discover(pos, oldValue);
    }
  }

  public static void effect(final Visual effect) {
  ...
  public static void flash(final int color) {
  ...
  public static void handleCell(final int cell) {
    cellSelector.select(cell);
  }

  public static void pickUp(final Item item) {
  ...
  public static Ripple ripple(final int pos) {
  ...
  public static WndBag selectItem(final WndBag.Listener listener, final WndBag.Mode mode,
      final String title) {
  ...
  public static void updateMap(final int cell) {
    if (scene != null) {
  ...
  private void addDiscardedSprite(final Heap heap) {
  ...
  private void addHeapSprite(final Heap heap) {
  ...
  private void addMobSprite(final Mob mob) {
  ...
  private void addPlantSprite(final Plant plant) {
