...
public enum HeroSubClass {
  ...
  GLADIATOR("gladiator",
      "A successful attack with a melee weapon allows the _Gladiator_ to start a combo, " +
          "in which every next successful hit inflicts more damage."), BERSERKER("berserker",
  ...
  WARLOCK("warlock",
      "After killing an enemy the _Warlock_ consumes its soul. " +
          "It heals his wounds and satisfies his hunger."), BATTLEMAGE("battlemage",
  ...
  SNIPER("sniper",
      "_Snipers_ are able to detect weak points in an enemy's armor, " +
          "effectively ignoring it when using a missile weapon."), WARDEN("warden",
              "Having a strong connection with forces of nature gives _Wardens_ an ability to gather dewdrops and "
                  +
                  "seeds from plants. Also trampling a high grass grants them a temporary armor buff."), PALADIN(
                      "paladin",
                      "_Paladin_ is the ordained kinght of Estera. The Paladin gains a bonus against demons. "
                          +
                          "Knights of Estera feel less the weight of the weapons and armor."), HIGHPRIEST(
                              "high priest",
