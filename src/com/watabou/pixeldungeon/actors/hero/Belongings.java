...
public class Belongings implements Iterable<Item> {
    ...
    public int charge(final boolean full) {
    ...
    public <T extends Item> T getItem(final Class<T> itemClass) {
    ...
    @SuppressWarnings("unchecked")
    public <T extends Key> T getKey(final Class<T> kind, final int depth) {
    ...
    public void resurrect(final int depth) {
