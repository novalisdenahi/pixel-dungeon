...
public class Painter {
    ...
    public static Point drawInside(final Level level, final Room room, final Point from, final int n, final int value) {
    ...
    public static void fill(final Level level, final int x, final int y, final int w, final int h, final int value) {
    ...
    public static void fill(final Level level, final Rect rect, final int m, final int value) {
        Painter.fill(level, rect.left + m, rect.top + m, (rect.width() + 1) - (m * 2), (rect.height() + 1) - (m * 2),
                value);
    }

    public static void fill(final Level level, final Rect rect, final int l, final int t, final int r, final int b,
            final int value) {
        Painter.fill(level, rect.left + l, rect.top + t, (rect.width() + 1) - (l + r), (rect.height() + 1) - (t + b),
                value);
    }
