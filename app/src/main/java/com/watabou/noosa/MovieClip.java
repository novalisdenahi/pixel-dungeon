...
public class MovieClip extends Image {
  ...
  public static class Animation {
    ...
    public Animation(final int fps, final boolean looped) {
      delay = 1f / fps;
      this.looped = looped;
    }
    ...
    public Animation frames(final RectF... frames) {
      this.frames = frames;
      return this;
    }

    public Animation frames(final TextureFilm film, final Object... frames) {
  ...
  public MovieClip(final Object tx) {
    super(tx);
  }

  public void play(final Animation anim) {
    play(anim, false);
  }
