...
public class PixelScene extends Scene {
  ...
  protected static class Fader extends ColorBlock {
    ...
    public Fader(final int color, final boolean light) {
  ...
  private static class PixelCamera extends Camera {
    ...
    public PixelCamera(final float zoom) {
      super(
    ...
    protected void updateMatrix() {
      float sx = PixelScene.align(this, scroll.x + shakeX);
      float sy = PixelScene.align(this, scroll.y + shakeY);
  ...
  public static float align(final Camera camera, final float pos) {
  ...
  public static void align(final Visual v) {
    Camera c = v.camera();
  ...
  public static BitmapTextMultiline createMultiline(final String text, final float size) {
  ...
  public static BitmapText createText(final float size) {
    return PixelScene.createText(null, size);
  }

  public static BitmapText createText(final String text, final float size) {
  ...
  public static void showBadge(final Badges.Badge badge) {
    ...
    banner.x = PixelScene.align(banner.camera, (banner.camera.width - banner.width) / 2);
    banner.y = PixelScene.align(banner.camera, (banner.camera.height - banner.height) / 3);
  ...
  protected void fadeIn(final int color, final boolean light) {
