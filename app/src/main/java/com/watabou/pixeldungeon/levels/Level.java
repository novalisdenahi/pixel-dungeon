...
public abstract class Level implements Bundlable {
  ...
  public static final int[] NEIGHBOURS8 =
      { +1, -1, +WIDTH, -WIDTH, +1 + WIDTH, +1 - WIDTH, -1 + WIDTH, -1 - WIDTH };
  public static final int[] NEIGHBOURS9 =
      { 0, +1, -1, +WIDTH, -WIDTH, +1 + WIDTH, +1 - WIDTH, -1 + WIDTH, -1 - WIDTH };
  ...
  public static void set(final int cell, final int terrain) {
  ...
  public int adjustPos(final int pos) {
  ...
  public Heap drop(Item item, int cell) {
    ...
    if (Dungeon.isChallenged(Challenges.NO_FOOD) && (item instanceof Food)) {
      ...
      item = new Gold(item.price());
        ...
        && ((item instanceof Scroll) || (item instanceof ScrollHolder))) {
  ...
  public void mobPress(final Mob mob) {
  ...
  public Plant plant(final Plant.Seed seed, final int pos) {
  ...
  public Actor respawner() {
    return new Actor() {
      ...
      protected boolean act() {
        ...
        spend(
            Dungeon.nightMode || Statistics.amuletObtained ? TIME_TO_RESPAWN / 2 : TIME_TO_RESPAWN);
        return true;
      }
    };
  }
  ...
  public boolean[] updateFieldOfView(final Char c) {

    int cx = c.pos % WIDTH;
    int cy = c.pos / WIDTH;

    boolean sighted =
        (c.buff(Blindness.class) == null) && (c.buff(Shadows.class) == null) && c.isAlive();
    if (sighted) {
  ...
  public void uproot(final int pos) {
    plants.delete(pos);
  }
